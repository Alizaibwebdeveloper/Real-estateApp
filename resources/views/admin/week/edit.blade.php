...
@section('agent')
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('admin/users') }}">Weeks</a></li>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ url('admin/week/edit/' . $week->id) }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control" placeholder="Enter Name"
                                        class="required" value="{{ $week->name }}">
                                </div>
                            </div>
